...
A high-performance video recording framework built on FFmpeg, supporting the conversion of multiple input sources (local video, camera, RTSP streams, desktop, etc.) into a continuous sequence of image frames. 
